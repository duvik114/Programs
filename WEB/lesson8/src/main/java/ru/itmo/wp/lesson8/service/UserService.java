...
public class UserService {
    ...
    public void updateDisabled(UserDisabledCredentials userDisabledCredentials) {
        userRepository.updateDisabled(userDisabledCredentials.getId(),
                userDisabledCredentials.getIsDisabled().equals("Disable"));
    }
